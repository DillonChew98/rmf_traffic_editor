...
/////////////////////////////
  ...
  QTableWidgetItem * create_table_item(
    const QString & str,
    bool editable = false);
  ...
  std::unique_ptr < floorplan_annotator::FeatureDetection > handle_;
...
private:
  ...
  void mouse_lane_gen(const MouseType t, QMouseEvent * e, const QPointF & p);

  void mouse_add_human_lane(
    const MouseType t, QMouseEvent * e,
    const QPointF & p);
